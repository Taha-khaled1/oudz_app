...
class ColorManager {
  static Color kPrimary2 = Color(0xff1f3976);
  static const Color white = Color(0xff1c252c);
  ...
  static Color kPrimary = Color(0xff1f3976);
  static Color primaryColorbu = Color(0xFF2697FF);
  static Color secondaryColor = Color(0xFF2A2D3E);
  static Color bgColor = Color(0xFF8c8c8c);
  ...
  Gradient x = const LinearGradient(
    colors: [
      Color(0xff66a6ff),
      Color(0xff89f7fe),
    ],
  ...
  static Gradient y = const LinearGradient(
    colors: [
      Color(0xff6991c7),
      Color(0xffa3bded),
    ],
  ...
  static Gradient z = const LinearGradient(
    colors: [
      Color(0xff000000),
      Color(0xff434343),
    ],
